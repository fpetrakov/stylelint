...
testRule({
	...
	reject: [
		...
		{
			code: 'a { display: flex !important; display: inline-flex; }',
			fixed: 'a { display: flex !important; }',
			description: 'handle single !important',
		...
		{
			code: 'a { display: flex !important; display: inline-flex !important; display: grid !important; }',
			fixed: 'a { display: grid !important; }',
			description: 'handle multiple !important',
			message: messages.rejected('display'),
			line: 1,
			column: 64,
			endLine: 1,
